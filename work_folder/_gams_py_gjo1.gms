...
qS.fx[t,s,n]$((output_APi[s,n] and ( not ((endo_qS_APi[s,n] and t0[t]))))) = qS.l[t,s,n];
sigma.fx[s,n]$(kninp_APi[s,n]) = sigma.l[s,n];
eta.fx[s,n]$(knout_APi[s,n]) = eta.l[s,n];
mu.fx[s,n,nn]$(exomu_APi[s,n,nn]) = mu.l[s,n,nn];
...
qD.fx[t,s,n]$(((((int_APi[s,n] or input_APi[s,n]) and t0[t]) and ( not ((endo_qD_APi[s,n] and t0[t])))) or (dur_APi[s,n] and t0[t]))) = qD.l[t,s,n];
...
mu.lo[s,n,nn]$((map_APi[s,n,nn] and ( not (exomu_APi[s,n,nn])))) = -inf;
mu.up[s,n,nn]$((map_APi[s,n,nn] and ( not (exomu_APi[s,n,nn])))) = inf;
qS.lo[t,s,n]$((endo_qS_APi[s,n] and t0[t])) = -inf;
qS.up[t,s,n]$((endo_qS_APi[s,n] and t0[t])) = inf;
