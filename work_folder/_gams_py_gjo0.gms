...
# -----------------------------------------B_ModelTest_B_Tree1----------------------------------------
#  Initialize B_ModelTest_B_Tree1 equation block
# ----------------------------------------------------------------------------------------------------
...
# ----------------------------------------------------------------------------------------------------
#  Define B_ModelTest_B_Tree1 model
# ----------------------------------------------------------------------------------------------------
Model B_ModelTest_B_Tree1 /
...
# -----------------------------------------B_ModelTest_B_Tree2----------------------------------------
#  Initialize B_ModelTest_B_Tree2 equation block
# ----------------------------------------------------------------------------------------------------
...
# ----------------------------------------------------------------------------------------------------
#  Define B_ModelTest_B_Tree2 model
# ----------------------------------------------------------------------------------------------------
Model B_ModelTest_B_Tree2 /
...
mu.fx[s,n,nn]$((exomu_ModelTest_A[s,n,nn] or ( not (exomu_ModelTest_A[s,n,nn])))) = mu.l[s,n,nn];pD.lo[t,s,n]$(int_ModelTest_A[s,n]) = -inf;
